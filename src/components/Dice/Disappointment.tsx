...
const Disappointment = ({ length, index }: DisappointmentProp) => {
	return (
		<div
			className={`relative w-[220px] h-[95px] bg-white z-10 border-[1px] transition-all overflow-hidden border-[#15323d] ${
				length - 1 === index && 'absolute group-hover:w-[400px] group-hover:h-[220px]'
			} ${index === 0 ? '' : 'mt-[-75px]'}`}>
